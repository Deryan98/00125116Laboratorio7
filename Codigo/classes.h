...
enum parameters {VAR_TAO,VAR_KAPPA,VAR_LAMBDA,VAR_PSIX,VAR_PSIY,VAR_DELTA,VAR_ETA};
...
class mesh{
    ...
    public:
        void setParameters(float T,float K, float L, float PX, float PY, float D, float E){
            parameters[VAR_TAO]=T;
            parameters[VAR_KAPPA]=K;
            parameters[VAR_LAMBDA]=L;
            parameters[VAR_PSIX]=PX;
            parameters[VAR_PSIY]=PY;
            parameters[VAR_DELTA]=D;
            parameters[VAR_ETA]=E;
        }
